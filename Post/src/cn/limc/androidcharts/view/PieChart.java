...
public class PieChart extends View {
	...
	protected void drawData(Canvas canvas) {
		if (null != data) {
			...
			mPaintBorder.setColor(getResources().getColor(R.color.transparent));
			...
			for (int k = 0; k < data.size(); k++) {
				...
				canvas.drawText(title, realx + 2, realy, mPaintFont);

				canvas.drawText(String.valueOf(percentage) + "%", realx + 2,
						realy + 20, mPaintFont);
