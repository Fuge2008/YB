...
public class CandleStickChart extends GridChart {
	...
	/** 阳线边�?��色 */
	public static final int DEFAULT_POSITIVE_STICK_BORDER_COLOR = 0xffEC3C3C;

	/** 阳线填�?��色 */
	public static final int DEFAULT_POSITIVE_STICK_FILL_COLOR = 0xffEC3C3C;

	/** 阴线边�?��色 */
	public static final int DEFAULT_NEGATIVE_STICK_BORDER_COLOR = 0x098F1A;

	/** 阴线填�?��色 */
	public static final int DEFAULT_NEGATIVE_STICK_FILL_COLOR = 0xff098F1A;
	...
	public String getAxisYGraduate(Object value) {
		...
		return String.valueOf((int) Math.floor(graduate * (maxPrice - minPrice)
				+ minPrice));
	}
	...
	protected void initAxisY() {
		...
		for (int i = 0; i < latitudeNum; i++) {
			String value = String.valueOf((int) Math.floor(minPrice + i
					* average));
	...
	//	float stickWidth = ((super.getWidth() - super.getAxisMarginLeft() - super
		...
		float stickWidth = ((super.getWidth() - super.getAxisMarginLeft() - super
				.getAxisMarginRight()-2) / 119);
		// 蜡烛棒起始绘制位置
		//float stickX = super.getAxisMarginLeft() + 1;
		float stickX = super.getWidth()-1-stickWidth;
