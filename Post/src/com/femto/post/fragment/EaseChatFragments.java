...
/** * @author  作者 Deep  @date 创建时间：2016年6月20日 下午5:04:37 * @version 1.0 * @parameter  * @since  * @return  */
public class EaseChatFragments extends EaseBaseFragment implements EMMessageListener {
